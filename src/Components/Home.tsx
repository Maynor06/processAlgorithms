...
const Home = () => {
  ...
  // NUEVO: controla la pantalla de bienvenida (maqueta/hero)
  ...
  // ===== Maqueta (pantalla inicial tipo landing/hero) =====
  if (showLanding) {
    return (
      <div className="hero">
        {/* Barra superior */}
        <header className="hero__nav">
          ...
          <nav className="hero__links">
            <a className="hero__link" href="#" onClick={() => setShowLanding(false)}>Inicio</a>
            <a className="hero__link" href="https://github.com/Maynor06/processAlgorithms/blob/master/README.md">Acerca de</a>
        ...
        <div className="hero__chipShadow" aria-hidden="true" />
      </div>
    );
  }
  // ===== Fin maqueta =====
    ...
    <>
      <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]">
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_800px_at_100%_200px,#d5c5ff,transparent)]">
          ...
          <h1
            className="relative top-8 text-6xl font-bold text-center"
            style={{ fontFamily: "'Coiny', sans-serif" }}
          >
            Simulador
          </h1>
          <h1
            className="relative top-8 text-5xl font-bold text-center"
            style={{ fontFamily: "'Coiny', sans-serif" }}
          >
            Gestor de Procesos en Memoria
          </h1>
          ...
          <div className="mr-auto ml-auto w-[40%] mt-4 flex gap-2 ">
            ...
            <button
              onClick={irASimulator}
              className="bg-[#d7c8ff] transition-all duration-[2000ms] hover:scale-110 hover:bg-blue-200 h-12 w-56 rounded-2xl text-xl "
              style={{ fontFamily: "'Coiny', system-ui" }}
            >
              Iniciar Simulación
            </button>
          </div>
